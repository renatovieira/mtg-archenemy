...
public class Card {
	...
	static {
		...
		nameToResId.put("og_nature_shields_its_own.jpg", R.drawable.og_nature_shields_its_own);
		nameToResId.put("og_nothing_can_stop_me_now.jpg", R.drawable.og_nothing_can_stop_me_now);
		...
		nameToResId.put("rotted_ones_lay_siege.jpg", R.drawable.rotted_ones_lay_siege);
